...
const Banner = () => {
    ...
    return (
        <div className={`${dark ? "bg-[url('keyboard.jpg')]" : "bg-[url('sony.jpg')]" }   bg-cover w-full min-h-[90vh] bg-center `}>
            <div className='w-full h-full min-h-[90vh]  backdrop-brightness-[0.1] flex flex-col pt-28 items-center'>
                   <h1 className={`lg:text-5xl  text-4xl text-white  text-center`}>Unleash Your Digital Dreams</h1>
